...
from src.crawler_vnexpress.utils import retry, get_soup
...
class BaseCrawler(ABC):
    ...
    def __init__(self, *args, **kwargs):
        self.__timeout = kwargs.get("timeout", Config.TIMEOUT)
    ...
    def _fetch(self, url: str, *args, **kwargs):
        ...
        assert response.status_code == 200, f"Failed to fetch page: {url} (status {response.status_code})"
